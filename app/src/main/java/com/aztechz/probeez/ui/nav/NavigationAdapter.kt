...
class NavigationAdapter(
    ...
    interface NavigationAdapterListener {
        ...
        fun onNavTaskFolderClicked(folder: NavigationModelItem.NavTaskFolder)
    }
    ...
    override fun getItemViewType(position: Int): Int {
        return when (getItem(position)) {
            ...
            is NavigationModelItem.NavTaskFolder -> VIEW_TYPE_NAV_EMAIL_FOLDER_ITEM
    ...
    override fun onCreateViewHolder(
        ...
        return when (viewType) {
            ...
            VIEW_TYPE_NAV_EMAIL_FOLDER_ITEM -> NavigationViewHolder.TaskFolderViewHolder(
                NavTaskFolderItemLayoutBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false
                ),
